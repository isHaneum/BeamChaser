        ...
        Button {
            ...
            VStack(spacing: 6) {
                ...
                Text(value)
                    ...
                    .foregroundStyle(isOn ? .white : RBColor.textTertiary)
                    .lineLimit(1)
                ...
                ForEach(distancePresets, id: \.self) { dist in
                    Button {
                        ...
                        Text(dist == 21.1 ? "하프" : "\(Int(dist))km")
                            ...
                            .foregroundStyle(targetDistanceKm == dist ? .white : RBColor.textSecondary)
            ...
            HStack(spacing: 8) {
                ForEach([15, 20, 30, 45, 60], id: \.self) { mins in
                    Button {
                        ...
                        Text("\(mins)분")
                            .font(RBFont.label(12))
                            .foregroundStyle(targetTimeMinutes == mins ? .white : RBColor.textSecondary)
                ...
                ForEach(secondsPresets, id: \.self) { sec in
                    Button {
                        ...
                        Text("\(sec)")
                            ...
                            .foregroundStyle(paceSeconds == sec ? .white : RBColor.textSecondary)
                            .frame(maxWidth: .infinity)
                            .frame(height: 38)
